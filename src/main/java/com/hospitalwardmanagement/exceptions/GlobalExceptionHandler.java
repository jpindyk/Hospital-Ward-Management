...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(HealthQuestionnaireExistsException.class)
    public ResponseEntity<ErrorObject> handleHealthQuestionnaireExistsException(
                                        HealthQuestionnaireExistsException exception,
                                        WebRequest request) {
